...
#	
#	Version 3.2
#	2004-02-13:	ＩＤ番号が原因でログ順番が変わるバグを修正
#
#	Version 3.1.7
#	2003-09-20:	編集時に順番が入れ替わるバグを修正
#
#	Version 3.1.6
#	2003-07-25:	記事追加時のsubid設定の不具合とそれに伴う障害の修正
#
#	Version 3.1.5
#	2003-07-25:	編集画面の表示が昇順で表示されるバグを修正
#	
#	Version 3.1.4+
...
my $htmlPath	= "../skin.html";								#トップページのスキン
...
$colsize = "70";		#メインテキストエリア高さ
$rowsize = "15";

$colsize1 = "70";		#サブテキストエリア高さ
$rowsize1 = "13";

$jiyuu = <<HTML;
<input type="button" value="文字自由編集" onclick="window.open('wysiwyg.html','WYSIWYG','scrollbars=yes,resizable=yes,status=yes,menubar=yes')"><br>
HTML
	...
	<TBODY>
		<TR>
			<TD align="center" valign="middle">
				<FORM action="topics.cgi" method="POST" name="FM">
...
print "<textarea name=\"comment\" rows=\"$rowsize\" cols=\"$colsize\" maxlength=\"50\"></textarea><br>$jiyuu\n<br>\n";
...
<div align="center">
<form action="topics.cgi" method="POST" name="FM"><input type="hidden" name="mode" value="3">
<table border="0" width="500" bgcolor="#ffd668" cellpadding="5" cellspacing="1">
<tr>
...
print "<div align=\"left\">　　本文:</div>\n";
print "<textarea name=\"comment\" rows=\"$rowsize\" cols=\"$colsize\" maxlength=\"50\">$comment</textarea>\n$jiyuu<br><br>\n";
print "<input type=\"submit\" value=\"　送　信　\">　<input type=\"reset\" value=\"　取　消　\"><br><br>\n";
print "</form>\n";
print "</td>\n";
print "</tr>\n";
...
print "<br><br>※さらに画像や記事を追加したい場合はクリックして下さい";
print "</form>\n";
print("</TD>\n");
print("</TR>\n");
print("</TABLE>\n");
...
foreach $line (@minComments){
	...
	print("<a href=\"../$fileName\" TARGET=\"_blank\"><img src=\"../$fileName\" width=\"$outWidth\" height=\"$outHeight\" border=\"0\"></a>\n");
	print("</td>\n");
...
<BODY>
	...
	<TBODY>
		<TR>
			<TD align="center" valign="middle">
				<FORM action="topics.cgi" method="POST" ENCTYPE="multipart/form-data" name="FM"><INPUT type="hidden" name="mode" value="9">
HTML_HEAD
...
if($baseName ne ""){
	...
	print("<a href=\"../$baseName\" TARGET=\"_blank\"><img src=\"../$baseName\" width=\"$outWidth\" height=\"$outHeight\" border=\"0\"></a>\n");
	print("</td></tr>\n");
	print("<input type=\"hidden\" name=\"upfile2\" value=\"$baseName\">\n");
}

print('<tr><td bgcolor="#ffffff">コメント<br>'."\n");
print("<textarea name=comment cols=$colsize1 rows=$rowsize1>$text</textarea>\n");
...
sub addCommentEdit
{
	...
	if($fileName ne "" and $baseName ne ""){
		...
		if($type eq "jpeg" or $type eq "gif" or $type eq "jpg" or $type eq "JPG" or $type eq "GIF" or $type eq "JPEG"){
			...
			close(OUTFILE);
			chmod(0666,"$outImageDir/$baseName");
		}else{
			#ファイル形式に対応していないとき
				...
				if(@htmlBody2 eq "" || $leftorright eq '0'){
					...
					foreach $line (@htmlBody1){
						...
						if($fileName ne ""){
							...
							$buf =~ s/<!--image-->/<a href="$fileName" TARGET="_blank"><img src="$fileName" width="$outWidth" height="$outHeight" border="0"><\/a>/g;	#画像データの埋め込み
						}
