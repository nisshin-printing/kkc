...
#■受信先メールアドレス
$mailto = 'info@bscl.co.jp';

#■名称
$title = '「広島経済活性化推進倶楽部」オンライン・サインアップ';

#■処理画面のボディ設定
$body = '<body bgcolor="#ffffff">';

#■スタイルシートの設定
$style = '<STYLE type="text/css">TD{font-size:14px;}</STYLE>';
...
<center>
<h1>内容確認</h1>
<font color=\"555555\">内容をご確認の上、下の送信ボタンを押して下さい</font>
<br>
<form method=\"post\" action=\"webform.cgi\">
<table width=\"500\" bgcolor=\"#cccccc\" cellpadding=\"3\" cellspacing=\"1\">
<tr><td bgcolor=\"#ffcccc\" width=\"200\" align=\"center\"><b>項目</b></td><td bgcolor=\"#ffcccc\" width=\"300\" align=\"center\"><b>内容</b></td></tr>
...
foreach (0..$count-1) {
	...
	if ($DATA_VS[($_)] =~ /\n/) { print "<td bgcolor=\"#ffffff\">$DATA_VS[($_)]</td></tr>\n"; }
...
else { print "<br><input type=submit value=\"　送　信　\">\n"; }

print "</form><hr>\n";
print "利用責任者(送信先)：<a href=\"mailto:$mailto\">$mailto</a>\n";
